...
<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
	 <h2 className={looking.json}>motivation : &#123;</h2>
				...
				<h2 className={looking.jsonSub}><span className={looking.highlight}>Code</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Meditate</span>,</h2>
